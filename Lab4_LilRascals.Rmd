...
ggplot(data = babies) +
    ...
    scale_fill_discrete(name = "Premature births (0 = not premature, 1 = premature")
```
...
#### Our Findings:
Our findings were that generally the population of women who smoked the most had the fewest babies, and that the proportion of premature to mature  born babies was roughly the same for women who didn't smoke and women who smoked multiple cigarettes a day historically. 
...
#### Our Conclusion:
The data shows that women who smoked more cigarettes did have a larger proportion of premature babies, although women who smoked more in general had fewer babies overall.  
...
Shreeya's Summary: I, Shreeya Basrur,created a density plot to analyse the distribution of race demographics for mothers in this study. I filled in the density plot yellow for visibility, and added the mean line to clarify the general density plot. I also added axis titles as well as an informative title to be easier to read. This plot was created with the geom_density function with aesthetic modifiers that filled in the plot yellow and added the dashed line. Geom_vline was the function I used to create the mean line for this plot. 
